...
- **AWS CLI**: Command-line tool; (recommended for v2) keyless log in via `aws login`, or use `aws configure` with an access key ID and secret access key created from console
