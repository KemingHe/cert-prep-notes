...
Ask your AI agent to revise study notes:

- "Revise my AWS EC2 notes with fact-checking"
- "Update my Kubernetes study notes"
- "Review and reorganize my Azure notes"
...
| File | Purpose |
| :--- | :--- |
| [`SKILL.md`](./SKILL.md) | AI instructions for notes revision |
| [`assets/notes-template.md`](./assets/notes-template.md) | Template for revised study notes output |
